...
const ModifyDoctors = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
			await axios.put(`${PROD_BACKEND_URL}/api/doctors`, {
				doctorId,
				detailColumn,
				newValue,
			});
	...
	return (
		<div className='container mx-auto max-w-md py-8'>
			...
			<form onSubmit={handleSubmit}>
				...
				<div className='mb-4'>
					<label htmlFor='detailColumn' className='block text-gray-700'>
						Detail Column:
					</label>
					<select
						type='text'
				...
				<div className='mb-6'>
					<label htmlFor='newValue' className='block text-gray-700'>
						New Value:
					</label>
					<input
						type='text'
