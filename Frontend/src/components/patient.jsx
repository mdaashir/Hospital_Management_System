		...
		<div className='min-h-screen bg-gradient-to-r from-blue-200 to-blue-400 flex flex-col lg:flex-row'>
			<div className='bg-white p-8 w-full lg:w-1/5'>
				...
				<div className='mb-6'>
					...
					<ul>
						<li
							className='cursor-pointer flex items-center mb-4 px-2 py-2 rounded-md transition duration-300 ease-in-out transform hover:bg-gray-100'
