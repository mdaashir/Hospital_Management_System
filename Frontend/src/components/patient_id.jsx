			...
			const fetchPatientDetails = async () => {
				try {
					...
					const response = await axios.get(
						`${PROD_BACKEND_URL}/api/patients/${patientId}`
					);
	...
	return (
		<div className='container mx-auto mt-10'>
			...
			<form
				...
				className='max-w-2xl mx-auto bg-gray-200 p-6 rounded-lg shadow-md'>
				<div className='mb-6 flex items-center justify-center'>
					<label
						htmlFor='patientId'
						className='block text-gray-900 font-bold mb-2 mr-2 w-1/3 text-3l'>
						Enter Patient ID:
					</label>
					<input
						type='text'
				...
				<div className='mt-8 max-w-2xl mx-auto bg-gray-200 p-6 rounded-lg shadow-md'>
					...
					<p className='flex flex-wrap'>
						<span className='w-1/3 font-semibold'>
							Already taking any prior medications ?{' '}
						</span>
