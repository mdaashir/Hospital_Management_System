			...
			const fetchDoctorDetails = async () => {
				try {
					const response = await axios.get(
						`${PROD_BACKEND_URL}/api/doctors/${doctorId}`
					);
	...
	return (
		<div className='container mx-auto mt-10'>
			...
			<form
				...
				className='max-w-md mx-auto bg-gray-200 p-6 rounded-lg shadow-md'>
				<div className='mb-6'>
					<label
						htmlFor='doctorId'
			...
			{submitted && doctorData && (
				<div className='mt-8 max-w-md mx-auto bg-gray-200 p-6 rounded-lg shadow-md'>
					...
					<p>
						<span className='font-semibold'>Name:</span> {doctorData.dname}
					</p>
					<p>
					...
					<p>
						<span className='font-semibold'>Contact:</span> {doctorData.contact}
					</p>
				</div>
			)}
		</div>
